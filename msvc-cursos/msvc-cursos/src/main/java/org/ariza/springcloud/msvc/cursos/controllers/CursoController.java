package org.ariza.springcloud.msvc.cursos.controllers;
...
import org.ariza.springcloud.msvc.cursos.services.CursoService;
...
public class CursoController {
    ...
    public ResponseEntity<?> detalle(@PathVariable Long id){
        Optional<Curso> o = service.porIdConUsarios(id); //service.porId(id);
        if(o.isPresent()){
